...
-(void)createPlayerAtPosition:(CGPoint)position {
    ...
    _player.physicsBody.restitution = 0.0f; // it doesnt lose any of its momentum during collisions
...
- (void)reportScoreToGameCenter {
    ...
    [[GameKitHelper sharedGameKitHelper]  reportScore:highStars forLeaderboardID:_leaderboardIDMap];
}
